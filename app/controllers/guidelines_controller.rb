class GuidelinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @guideline.save
        format.html { redirect_to guideline_url(@guideline), notice: "Guideline was successfully created." }
  ...
  def update
    respond_to do |format|
      if @guideline.update(guideline_params)
        format.html { redirect_to guideline_url(@guideline), notice: "Guideline was successfully updated." }
  ...
  private
    ...
    def guideline_params
      params.require(:guideline).permit(:number, :text)
    end
end
